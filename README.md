<h1 style="text-align: center; font-size: 60px;">JAVASCRIPT<h1>
<p><span style="font-weight: 900; font-size: 30px; color: yellow;">JavaScript </span>— is a popular programming 
language that has a wide range of 
applications.</p>
<p><span style="font-weight: 900; font-size: 30px; color: yellow;">JavaScript </span> was previously used mainly for 
...
apph1development and so on.</p>
<br>
<h1 style="text-align: center; color: black; border-radius: 20px; font-size: 40px; background-color: white;">JavaScript is also used in many other areas</h1>
<br>
<img style="width: 91%; margin-left: 5%;" src="image.png">
<br><br><br>
<h1 style="text-align: center; color: black; border-radius: 20px; font-size: 40px; background-color: white;">THE ROLE OF JAVASCRIPT IN WEB DEVELOPMENT</h1>
<br>
<img style="width: 91%; margin-left: 5%;" src="image copy.png">
<br><br><br>
...
<br>
<img style="width: 91%; margin-left: 5%;" src="image copy 4.png">
<br><br><br>
...
<br>
<img style="width: 91%; margin-left: 5%;" src="image copy 6.png">
<br><br><br>
<br><br><br>
...
<img style="width: 95%; margin-left: 3%;" src="image copy 8.png">
<br><br><br>
...
| ffff | fffef3f | ygeufg |
|--------------|:-----------:|------------|
| iuueggiuhegg| oihege9hh | uhu8gh9eug | -->
